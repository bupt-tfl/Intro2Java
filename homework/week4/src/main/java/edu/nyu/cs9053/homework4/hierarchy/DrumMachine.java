public class DrumMachine extends Autophones{
	
	private final String name;
	private final int age;
	
	public DrumMachine(String origin,String hsNumber,String imageUrl,String classificationName,String name, int age){
