public abstract class Membranophones extends MusicalInstruments{
	...
	protected Membranophones(String origin,String hsNumber,String imageUrl,String classificationName){
		this.origin = origin;
	...
	@Override public boolean equals(Object o){
		...
		Membranophones that = (Membranophones) o;
