public class ElectricGuitar extends Chordophones{
	
	
	private final String name;
	private final int age;
	
	public ElectricGuitar(String origin,String hsNumber,String imageUrl,String classificationName,String name, int age){
