...
public class Conversions {
    ...
    public static List<String> removeEmptyValuesJava8(List<String> values) {
    	...
    	Predicate<String> pred = (value) -> !value.trim().isEmpty() || value !=null;
    	List<String> nonEmpty =  values.stream().filter(pred).collect(Collectors.toList());
    	nonEmpty.forEach(value -> value.trim());
    	return nonEmpty;
    }
