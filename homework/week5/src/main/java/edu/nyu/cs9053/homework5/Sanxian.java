...
public class Sanxian extends Chordophones implements MusicalInstrument{	
	
	private final String name;
	private final int age;
	
	public Sanxian(String origin,String hsNumber,String imageUrl,String name, int age){
