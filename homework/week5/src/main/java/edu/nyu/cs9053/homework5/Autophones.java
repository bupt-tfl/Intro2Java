...
public abstract class Autophones implements MusicalInstrument{
	
	private final String origin;
	private final String hsNumber;
	private final String imageUrl;
	private static final String CLASSIFICATION_NAME = "Autophones";
	
	
	protected Autophones(String origin,String hsNumber,String imageUrl){
		this.origin = origin;
