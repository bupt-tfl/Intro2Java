...
public class BassGuitar extends Chordophones implements MusicalInstrument{
	
	private final String name;
	private final int age;
	
	public BassGuitar(String origin,String hsNumber,String imageUrl,String name, int age){
