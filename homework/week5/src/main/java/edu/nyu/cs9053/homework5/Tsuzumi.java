...
public class Tsuzumi extends Membranophones implements MusicalInstrument{
	
	private final String name;
	private final int age;
	
	public Tsuzumi(String origin,String hsNumber,String imageUrl,String name, int age){
