...
public class Triangle extends Autophones implements MusicalInstrument{
	
	private final String name;
	private final int age;
	
	public Triangle(String origin,String hsNumber,String imageUrl,String name, int age){
