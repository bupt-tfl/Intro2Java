...
public class ElectricGuitar extends Chordophones implements MusicalInstrument{	
	
	private final String name;
	private final int age;
	
	public ElectricGuitar(String origin,String hsNumber,String imageUrl,String name, int age){
