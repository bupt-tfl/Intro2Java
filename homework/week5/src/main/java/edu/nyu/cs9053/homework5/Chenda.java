...
public class Chenda extends Membranophones implements MusicalInstrument{	
	
	private final String name;
	private final int age;
	
	public Chenda(String origin,String hsNumber,String imageUrl,String name, int age){
