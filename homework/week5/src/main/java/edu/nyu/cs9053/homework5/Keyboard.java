...
public class Keyboard extends Autophones implements MusicalInstrument{
	
	private final String name;
	private final int age;
	
	public Keyboard(String origin,String hsNumber,String imageUrl,String name, int age){
